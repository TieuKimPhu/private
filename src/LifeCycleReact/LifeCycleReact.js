...
export default class LifeCycleReact extends Component {
    ...
    shouldComponentUpdate(newProps,newState) {
        //return true thì chạy tiếp các lifecycle còn lại, ngược lại return false thì sẽ dừng lại, không chạy tiếp lifecycle khác
        return true;
    }
    ...
    //Được gọi sau render và chỉ gọi 1 lần duy nhất (trạng thái mouting)
    componentDidMount(){
